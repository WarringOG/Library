...
public class ItemUtils {
    ...
    public static ItemStack getConfigItem(ConfigurationSection sec) {
    ...
    public static ItemStack getConfigItem(ConfigurationSection sec, ItemStack item) {
    ...
    public static ItemBuilder parseMaterial(String material) {
    ...
    public static ItemStack getConfigItem(ConfigurationSection sec, String[] replace, String[] replacements) {
        String[] args = sec.getString("Material").split(";");
        int data;
        try {
            data = Integer.parseInt(args[1]);
    ...
    public static ItemStack getConfigItem(ConfigurationSection sec, ItemStack item, String[] replace, String[] replacements) {
        ItemBuilder builder = new ItemBuilder(item.getType(), item.getData().getData());
        String message = sec.getString("Name");
        for (int i = 0; i < replace.length; i++) {
            message = message.replaceAll(replace[i], replacements[i]);
