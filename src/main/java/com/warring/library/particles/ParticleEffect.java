...
public enum ParticleEffect
{
    ...
    INSTANT_SPELL("INSTANT_SPELL", 14, "instantSpell", 14, -1, new ParticleProperty[0]),
    MOB_SPELL("MOB_SPELL", 15, "mobSpell", 15, -1, new ParticleProperty[] { ParticleProperty.COLORABLE }),
    MOB_AMBIENT_SPELL("MOB_AMBIENT_SPELL", 16, "mobSpellAmbient", 16, -1, new ParticleProperty[] { ParticleProperty.COLORABLE }),
    WITCH_SPELL("WITCH_SPELL", 17, "witchMagic", 17, -1, new ParticleProperty[0]),
    ...
    private ParticleEffect(String s, int n, String name, int id, int requiredVersion, ParticleProperty[] properties) {
        this.name = name;
        this.id = id;
    ...
    private static boolean isColorCorrect(ParticleEffect effect, ParticleColor color) {
        return ((effect == ParticleEffect.MOB_SPELL || effect == ParticleEffect.MOB_AMBIENT_SPELL || effect == ParticleEffect.REDSTONE) && color instanceof OrdinaryColor) || (effect == ParticleEffect.NOTE && color instanceof NoteColor);
    }
    ...
    public enum ParticleProperty
    {
        ...
        private ParticleProperty(String s, int n) {
        }
    }
